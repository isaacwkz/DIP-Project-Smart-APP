...
class ImageEditorPro extends StatefulWidget {
  ...
  ImageEditorPro({this.editdis, this.appBarColor, this.bottomBarColor});
...
// ValueChanged<Color> callback
  ...
  void initState() {
    ...
    super.initState();
    getImageToEdit(widget.editdis);
  }

  Future<void> getImageToEdit(File _imageToEdit) async {
    print("ANNOTATION: working on image - ${_imageToEdit.path}");
    var decodedImage =
        await decodeImageFromList(
        _imageToEdit.readAsBytesSync());
    setState(() {
            ...
            new FlatButton(
                ...
                onPressed: () {
                  ...
                  screenshotController
                    ...
                    String originalFilePath = widget.editdis.path;
                    String paths = originalFilePath.substring(0, originalFilePath.indexOf('.'));
